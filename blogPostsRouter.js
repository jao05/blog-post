...
// Import the model used to create blog posts
...
router.post("/", (req, res) => {
  ...
  for (let i = 0; i < requiredFields.length; i++) {
    ...
    if (!(field in req.body)) {
      ...
      //********* return AND response? Why?? To end function there? Just want to confirm....*********
...
router.put("/:id", (req, res) => {
  ...
  // *********** Get clear on the sources of the ids being compared***********
